...
<SEO title="Devices — gtcd" description="Screen size breakdown for your GoatCounter site." />
...
<header class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6 sm:mb-8 animate-fade-in">
	<div>
		...
		<h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight">Screen Sizes</h1>
		<p class="text-sm mt-1.5" style="color: var(--color-muted-foreground);">Which screen sizes your visitors use.</p>
	</div>
...
{:else}
	<p class="text-sm py-10 text-center" style="color: var(--color-muted-foreground);">No device data available.</p>
{/if}
