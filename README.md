...
| `GOATCOUNTER_ADMIN_URL` |    No    | —                         | Public GoatCounter administration URL for users, API tokens, TOTP, imports, page management, dashboard preferences, and email reports.                                         |
